...
//fstream aces;
	...
	switch(switchnumb)
	{
		...
		case 3://formal communication
			while(1)
			{	
				tempfile.open("C:/Users/Robotlab/Desktop/adams simulation/_ADAMS_WZ/test.txt",ios::in);
				...
				if(M2C_ID==127)
				{
					...
					tempfile.open("C:/Users/Robotlab/Desktop/adams simulation/_ADAMS_WZ/test.txt",ios::out| ios::trunc);
					for(int i=0;i<datasize;i++)
					{
						tempfile<<data[dataindexstart+i]<<"\t";
					}
